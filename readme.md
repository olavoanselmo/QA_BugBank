...
2. [1.1 Objetivos](## 🔍 1.1 Objetivos)
3. [1.2 Descrição da aplicação](## 1.2 Descrição da Aplicação)
...
**Taxa de Sucesso/Fracasso de Teste:** Proporção de testes bem-sucedidos em olavoanselmo@  
...
**login, cadastro de usuário, transferências,** 
